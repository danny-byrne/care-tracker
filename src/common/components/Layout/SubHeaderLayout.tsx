...
import { Stack, Text, IconButton, Separator, PrimaryButton } from '@fluentui/react';
...
const SubHeaderLayout: React.FC<SubHeaderLayoutProps> = ({
    ...
    return (
        <div className={classNames['wc-SubHeaderLayout--centeringContainer']}>
            ...
            {(!isMobile || isPanel) && (
                <div className={classNames['wc-SubHeaderLayout--container']}>
                    <div className={classNames['wc-SubHeaderLayout--subHeader']}>
                        <div>
                            <Text className={classNames['wc-SubHeaderLayout--subHeaderText']}>{title}</Text>
                        </div>
                        <Stack
            ...
            <div className={classNames['wc-SubHeaderLayout--contentContainer']}>{children}</div>
        </div>
    );
};
