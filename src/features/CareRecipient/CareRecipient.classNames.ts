...
export const getClassNames = (): ICarePlanClassNames => {
    return mergeStyleSets({
        ...
        'wc-CareRecipientCard--Persona': { marginTop: -45, marginLeft: 24, marginBottom: -15, marginRight: 0 },
...
export const coverPhotoStyle: IStyleFunctionOrObject<IDocumentCardImageStyleProps, IDocumentCardImageStyles> = {
    root: {
