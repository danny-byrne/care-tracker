...
const ConditionListItem: React.FC<MedicationListItemProps> = ({ name, id, timeframeText, hasNoStartDate }) => {
    ...
    const navigateToConditionDetailsPage = () => {
        trackClick('condition-list-item');
    ...
    const ConditionTextWithStartDate = () => {
        return (
            <Text className={classNames['wc-ConditionListItem--timeframe']} data-testid={'conditon-timeframe'}>
                {timeframeText}
            </Text>
        );
    };
    ...
    return (
        ...
        >
            <DocumentCard className={classNames['wc-ConditionListItem--ConditionCard']}>
                <Stack className={classNames['wc-ConditionListItem--container']} tokens={{ childrenGap: 4 }}>
                    <Text className={classNames['wc-ConditionListItem--name']} data-testid={'conditon-name'}>
                        {name}
                    </Text>
                    {hasNoStartDate ? <ConditionTextWithNoStartDate /> : <ConditionTextWithStartDate />}
                </Stack>
            </DocumentCard>
        </div>
    );
